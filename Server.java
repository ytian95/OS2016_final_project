...
public class Server implements Runnable {
    ...
    private void dataTransfer(ServerSocket serverSocket, BufferedReader input, DataOutputStream output) throws IOException, InterruptedException {
    ...
    private void httpHandler(BufferedReader input, DataOutputStream output) {
		try {
            ...
            dataTransfer(serverSocket, input, output);
		}
